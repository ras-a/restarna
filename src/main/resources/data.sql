...
CREATE SEQUENCE ADDRESS_SEQ START WITH 1 NOCACHE;
DROP SEQUENCE ADMIN_SEQ;
CREATE SEQUENCE ADMIN_SEQ START WITH 1 NOCACHE;
DROP SEQUENCE BREAD_SEQ;
CREATE SEQUENCE BREAD_SEQ START WITH 1 NOCACHE;
DROP SEQUENCE CREAM_SEQ;
CREATE SEQUENCE CREAM_SEQ START WITH 1 NOCACHE;
DROP SEQUENCE CREDIT_CARD_SEQ;
CREATE SEQUENCE CREDIT_CARD_SEQ START WITH 1 NOCACHE;
DROP SEQUENCE CUSTOMER_SEQ;
CREATE SEQUENCE CUSTOMER_SEQ START WITH 1 NOCACHE;
DROP SEQUENCE ITEM_SEQ;
CREATE SEQUENCE ITEM_SEQ START WITH 1 NOCACHE;
DROP SEQUENCE ORDER_SEQ;
CREATE SEQUENCE ORDER_SEQ START WITH 1 NOCACHE;